...
class BookServiceTest {
    ...
    static Stream<Arguments> getBooksByTitleParams() {
        return Stream.of(
                ...
                Arguments.of(Arrays.asList(new Book(1L,"Harry Potter", "Author", "Content")),
                        Arrays.asList(new Book(1L,"Harry Potter", "Author", "Content"))),
                Arguments.of(Arrays.asList(new Book(1L,"Harry Blotter", "Author", "Content")),
                        Collections.emptyList())
        );
    }
